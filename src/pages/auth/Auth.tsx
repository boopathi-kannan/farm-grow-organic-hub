                  ...
                  <form>
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <Input id="registerEmail" placeholder="name@example.com" required type="email" />
                      </div>
                      <div className="space-y-2">
            ...
            <CardFooter className="flex justify-center border-t pt-6">
              {activeTab === "login" ? (
                <p className="text-sm text-center">
                  ...
                  <a href="#" onClick={(e) => { e.preventDefault(); setActiveTab("register"); }} className="text-farm-green-600 hover:underline">
                    Sign up
                  </a>
                </p>
              ) : (
                <p className="text-sm text-center">
                  ...
                  <a href="#" onClick={(e) => { e.preventDefault(); setActiveTab("login"); }} className="text-farm-green-600 hover:underline">
                    Sign in
                  </a>
                </p>
              )}
